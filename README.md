...
```javascript
isLayout = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-assert-is-layout@v0.0.3-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-assert-is-layout@v0.0.3-umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/blas-base-assert-is-layout/actions/workflows/test.yml/badge.svg?branch=v0.0.3
[test-url]: https://github.com/stdlib-js/blas-base-assert-is-layout/actions/workflows/test.yml?query=branch:v0.0.3
